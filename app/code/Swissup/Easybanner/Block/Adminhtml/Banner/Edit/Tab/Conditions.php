...
class Conditions extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('easybanner_banner');
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'easybanner_banner_form')
    {
        ...
        $newChildUrl = $this->getUrl(
            'easybanner/banner/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $fieldset = $form->addFieldset(
            $fieldsetId,
            [
                'legend' => __('Conditions (don\'t add conditions if banner is applied to all pages)')
            ]
